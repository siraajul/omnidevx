...
const LOG_SEQUENCE = [
  { text: "==> Running Playwright E2E Test Suite...", color: "text-zinc-300" },
  ...
  { text: "==> Code coverage: 98.4% lines, 99.1% branches", color: "text-zinc-300" },
  { text: "---", color: "text-zinc-500" },
  { text: "==> Initializing AWS ECS Deployment...", color: "text-zinc-300" },
  { text: "==> Pushing container image to ECR [■■■■■■■■■■■■■■■■■■■■] 100%", color: "text-zinc-300" },
  ...
  return (
    <div className="h-full w-full bg-[#0D1117] p-4 md:p-8 flex flex-col gap-6 font-mono text-white overflow-hidden border border-zinc-800 rounded-xl">
      ...
      <div className="flex justify-between items-center pb-4 border-b border-zinc-800">
        ...
        <div className="flex gap-4 text-xs font-sans font-medium text-zinc-400">
      ...
      <div className="flex justify-between text-xs font-bold text-zinc-500 px-4 -mt-4">
        <span>COMMIT</span>
      ...
      <div className="flex-1 bg-black border border-zinc-800 rounded-xl p-4 flex flex-col shadow-inner overflow-hidden relative">
        <div className="text-zinc-500 text-xs mb-2 border-b border-zinc-800 pb-2 flex justify-between">
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto text-xs leading-relaxed space-y-1 scroll-smooth scrollbar-hide">
          ...
          <div className="text-zinc-500 animate-pulse mt-1">_</div>
        </div>
      </div>
