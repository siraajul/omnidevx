...
export const WebDevDashboard = () => {
  ...
  return (
    <div className="h-full w-full bg-zinc-50 dark:bg-zinc-950 p-4 md:p-6 flex flex-col gap-4 font-sans text-zinc-900 dark:text-white overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800">
      
      {/* Top Header */}
      <div className="flex justify-between items-center pb-4 border-b border-zinc-200 dark:border-zinc-800">
        <div className="font-bold tracking-widest text-zinc-400 text-xs">OMNIDEVX // ENTERPRISE ANALYTICS</div>
      ...
      <div className="flex gap-4 w-full">
        <div className="flex-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 shadow-sm flex flex-col justify-between">
          <div className="text-xs font-bold text-zinc-400 tracking-wider flex justify-between">
            {content.metrics.usersLabel.toUpperCase()} <span className="text-blue-500">—</span>
          </div>
      ...
      <div className="flex gap-4 flex-1">
        ...
        {/* Bar Chart Panel */}
        <div className="flex-[2] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 shadow-sm flex flex-col relative">
          <div className="text-xs font-bold text-zinc-400 tracking-wider flex justify-between mb-6">
          ...
          <div className="flex items-end justify-between flex-1 gap-2 md:gap-4 px-2 pb-2">
            <div className="w-full bg-blue-400 rounded-t-sm transition-all duration-1000 ease-out" style={{ height: `${chartHeights[0]}%` }}></div>
          ...
          <div className="absolute top-1/3 left-4 right-4 h-px bg-zinc-100 dark:bg-zinc-800/50 z-0 pointer-events-none"></div>
          <div className="absolute top-2/3 left-4 right-4 h-px bg-zinc-100 dark:bg-zinc-800/50 z-0 pointer-events-none"></div>
        </div>

        {/* Donut Chart Panel */}
        <div className="flex-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 shadow-sm flex flex-col">
          <div className="text-xs font-bold text-zinc-400 tracking-wider mb-4">SOURCES</div>
          <div className="flex-1 flex items-center justify-center relative">
            {/* Simulated Donut Chart using CSS */}
            <div className="w-24 h-24 rounded-full border-[12px] border-zinc-100 dark:border-zinc-800 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-500 transform origin-left"></div>
            ...
            <div className="absolute right-0 flex flex-col gap-2 text-[10px] font-medium">
              <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-blue-500"></div> Direct</div>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 shadow-sm">
        <div className="flex justify-between text-[10px] font-bold text-zinc-400 tracking-wider mb-3 pb-2 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <div className="flex justify-between items-center text-xs py-2">
          ...
          <div className="w-1/3 text-center text-zinc-500">42ms</div>
        ...
        <div className="flex justify-between items-center text-xs py-2">
          ...
          <div className="w-1/3 text-center text-zinc-500">{content.metrics.latency}</div>
          <div className="w-1/3 text-right">
            <span className="bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 px-3 py-1 rounded text-[10px] font-bold">{content.metrics.serverStatus.toUpperCase()}</span>
          </div>
        </div>
      </div>
