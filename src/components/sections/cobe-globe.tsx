...
export function Globe({
  ...
  arcs = [],
  className = "",
  markerColor = [0.145, 0.388, 0.921], // #2563EB Blue-600
  baseColor = [1, 1, 1], // White globe base
  arcColor = [0.145, 0.388, 0.921],
  glowColor = [0.94, 0.93, 0.91], // Matches #F9F9F7 background
  dark = 0, // Light mode
  mapBrightness = 10,
  markerSize = 0.035, // Slightly larger markers for visibility
