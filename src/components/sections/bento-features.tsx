                                ...
                                <div className="relative flex h-32 w-full max-w-[220px] items-center justify-center overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex flex-col items-center">
                                        <motion.div animate={{ y: [0, -4, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
                                            {Icon1 && <Icon1 className="size-6 text-blue-600 mb-2" strokeWidth={2} />}
                                        </motion.div>
                                        <span className="block text-4xl md:text-5xl font-black text-blue-600">{f1.stat || "100%"}</span>
                                    </div>
                                </div>
                    ...
                    {f2 && (
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
                            <CardContent className="pt-6 h-full flex flex-col">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-zinc-100 before:absolute before:-inset-2 before:rounded-full before:border before:border-zinc-100 items-center justify-center overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex items-center justify-center">
                                        <motion.div animate={{ scale: [1, 1.15, 1] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}>
                                            {Icon2 && <Icon2 className="size-10 text-blue-600" strokeWidth={1.5} />}
                                        </motion.div>
                                    </div>
                                </div>
                                ...
                                <div className="pt-6 lg:px-6 relative flex items-center justify-center h-[123px] overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex items-center justify-center">
                                        <motion.div animate={{ rotate: [-8, 8, -8] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
                                            {Icon3 && <Icon3 className="size-12 text-blue-600" strokeWidth={1.5} />}
                                        </motion.div>
                                    </div>
                                </div>
                                <div className="relative z-10 mt-auto space-y-2 text-center pt-8">
                                ...
                                <div className="relative -mb-6 -mr-6 mt-6 h-full min-h-[150px] border-l border-t border-zinc-100 p-6 py-6 sm:ml-6 bg-zinc-50/50 flex items-center justify-center overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex aspect-square size-24 rounded-full border border-blue-100 bg-white items-center justify-center shadow-sm">
                                        ...
                                        <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}>
                                            {Icon5 && <Icon5 className="size-10 text-blue-600" strokeWidth={1.5} />}
                                        </motion.div>
                                    </div>
                                </div>
                            </CardContent>
