...
export function HeroStatsCard() {
  return (
    <div className="flex flex-col gap-4 w-full max-w-[380px] lg:max-w-[420px] relative z-20">
      ...
      <div className="absolute inset-0 bg-[#111]/10 blur-3xl rounded-full translate-y-8 scale-95 pointer-events-none"></div>
      ...
      <div className="p-6 md:p-8 rounded-[2rem] bg-zinc-900/90 backdrop-blur-xl border border-white/10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] overflow-hidden relative">
        ...
        <div className="absolute -top-32 -right-32 w-64 h-64 bg-[#f5f3ea]0/20 blur-[60px] rounded-full pointer-events-none"></div>
        ...
        <div className="flex items-center gap-5 mb-8 relative z-10">
          <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 shadow-inner">
            <Target className="w-7 h-7 text-[#666]" strokeWidth={1.5} />
          </div>
          <div>
            <h3 className="text-[2.5rem] font-display text-white tracking-tight leading-none mb-1">8+</h3>
            <p className="text-[#444] font-medium text-sm">Projects Delivered</p>
          </div>
        </div>
        ...
        <div className="mb-8 relative z-10">
          <div className="flex justify-between items-center mb-3">
            <span className="text-[#444] font-medium text-sm">Client Satisfaction</span>
        ...
        <div className="flex items-start justify-between mb-8 relative z-10 px-2">
          <div className="text-center flex-1">
            <h4 className="text-2xl font-display text-white mb-1">2+</h4>
            <p className="text-[10px] text-[#444] font-hand">Years</p>
          </div>
          ...
          <div className="text-center flex-1">
            <h4 className="text-2xl font-display text-white mb-1">100%</h4>
            <p className="text-[10px] text-[#444] font-hand">Quality</p>
          </div>
          ...
          <div className="text-center flex-1">
            <h4 className="text-2xl font-display text-white mb-1">24/7</h4>
            <p className="text-[10px] text-[#444] font-hand">Support</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 relative z-10">
          <div className="px-4 py-2 rounded-full bg-white/5 border border-white/10 flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-[#666] tracking-widest">ACTIVE</span>
          </div>
          <div className="px-4 py-2 rounded-full bg-white/5 border border-white/10 flex items-center gap-2">
            <Crown className="w-3.5 h-3.5 text-yellow-500" strokeWidth={2.5} />
            <span className="text-xs font-bold text-[#666] tracking-widest">PREMIUM</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-5 rounded-3xl bg-zinc-900/90 backdrop-blur-xl border border-white/10 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col justify-center">
        <p className="text-[#444] font-medium mb-4 text-sm text-center">Trusted by Industry Leaders</p>
        <div className="flex items-center justify-between gap-2 px-1">
          ...
          <div className="flex items-center gap-1.5 opacity-60 hover:opacity-100 transition-opacity cursor-default grayscale hover:grayscale-0">
            ...
            <span className="font-bold text-[15px] text-[#666] tracking-tight whitespace-nowrap">Ruby</span>
          </div>
          {/* Logo 2: Chipset */}
          <div className="flex items-center gap-1.5 opacity-60 hover:opacity-100 transition-opacity cursor-default grayscale hover:grayscale-0">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-[#2A6FDB] shrink-0"><path d="M6 6h12v12H6z" fill="currentColor"/><path d="M4 8h2M4 12h2M4 16h2M18 8h2M18 12h2M18 16h2M8 4v2M12 4v2M16 4v2M8 18v2M12 18v2M16 18v2" stroke="currentColor" strokeWidth="2"/></svg>
            <span className="font-bold text-[15px] text-[#666] tracking-tight whitespace-nowrap">Chipset</span>
          </div>
          {/* Logo 3: Acme Corp */}
          <div className="flex items-center gap-1.5 opacity-60 hover:opacity-100 transition-opacity cursor-default grayscale hover:grayscale-0">
            ...
            <span className="font-bold text-[15px] text-[#666] tracking-tight whitespace-nowrap">Acme Corp</span>
          </div>
        </div>
      </div>
    </div>
