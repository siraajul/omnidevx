  ...
  return (
    <FlowArt aria-label="Omnidevx Story">
      ...
      <FlowSection aria-label="The mission" style={{ backgroundColor: '#000', color: '#fff' }}>
        ...
        <div className="flex flex-wrap gap-[2vw]">
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-400">Architecture</p>
          ...
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-400">Intelligence</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
              Embedding generative AI natively into your workflows to outpace the competition.
            </p>
          </div>
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-400">Speed</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
      ...
      <FlowSection aria-label="How it works" style={{ backgroundColor: '#F5F0E8', color: '#000' }}>
        ...
        <div className="flex flex-wrap gap-[2vw]">
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-600">01 — Discover</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
              We audit your architecture, define the MVP scope, and establish the precise data models required.
            </p>
          </div>
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-600">02 — Build</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
              Our engineers execute in rapid sprints, providing you with staging environments every step of the way.
            </p>
          </div>
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-600">03 — Scale</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
      ...
      <FlowSection aria-label="The vision" style={{ backgroundColor: '#1A3DE8', color: '#fff' }}>
        ...
        <div className="flex flex-wrap gap-[2vw]">
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-300">100M+</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
              API requests handled daily by the infrastructures we've designed.
            </p>
          </div>
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-300">$50M+</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
              Venture capital raised by the startups we've engineered products for.
            </p>
          </div>
          <div className="min-w-[160px] flex-1">
            <p className="mb-1 text-sm font-bold uppercase tracking-wider text-indigo-300">100%</p>
            <p className="text-[clamp(0.85rem,1.1vw,1rem)] leading-relaxed opacity-75">
      ...
      <FlowSection aria-label="Join us" style={{ backgroundColor: '#000', color: '#fff' }}>
        ...
        <hr className="my-[1.5vw] border-none border-t border-black/60" />
        <p className="mt-auto max-w-[60ch] text-[clamp(1rem,1.5vw,1.25rem)] font-medium leading-relaxed text-zinc-400">
